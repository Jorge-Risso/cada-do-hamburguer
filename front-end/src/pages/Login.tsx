    ...
    <div className="auth-shell flex min-h-screen items-center justify-center px-4">
      ...
      >
        ...
        <div className="flex flex-col items-center">
          ...
          <Link to="/">
            ...
            <img
              ...
              alt="Burger House"
              className="mb-4 h-24 w-auto transition-transform duration-300 hover:scale-105"
            />{" "}
          </Link>{" "}
        ...
        <div className="flex w-full flex-col gap-4">
          ...
          <p
            className={`text-center text-sm font-bold ${message ? "text-red-400" : "text-transparent"}`}
            aria-live="polite"
          >
            {" "}
            {message || "_"}{" "}
